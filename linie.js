...
P02:{
    ...
    "Rynek (Stanisławów)":[
        ...
        {n:"Wyspiańskiego 01"},
        {n:"Głowackiego 01"},
        {n:"PKP Sulejówek Miłosna 02"},
        {n:"Kopernika 02"},
        {n:"Wilsona 02"},
        {n:"Polna (Sulejówek) 02"},
        {n:"Bajkowa 02"},
        {n:"Matejki 02"},
        {n:"Mickiewicza 02"},
        {n:"Krucza 02"},
        ...
        {n:"Michałów II 02"},
        {n:"Michałów III 02"},
        {n:"Kąty Goździejewskie Drugie 02"},
        {n:"Kąty Goździejewskie Pierwsze 02"},
        {n:"Pustelnik 02"},
        {n:"Ciopan 02"},
        {n:"Zalesie 02"},
        {n:"Mały Stanisławów 02"},
    ...
    "Okuniew":[
        ...
        {n:"Ciopan 01"},
        {n:"Pustelnik 01"},
        {n:"Kąty Goździejewskie Pierwsze 01"},
        {n:"Kąty Goździejewskie Drugie 01"},
        {n:"Michałów III 01"},
        {n:"Michałów II 01"},
        {n:"Michałów I 01"},
        {n:"Wilcza 01"},
        ...
        {n:"Wilsona 01"},
        {n:"Kopernika 01"},
        {n:"PKP Sulejówek Miłosna 01"},
        {n:"Krótka (Sulejówek) 01"},
        {n:"Wyspiańskiego 02"},
        {n:"Szekspira 02"},
        {n:"Dąbrowskiego 02"},
        {n:"Łukasińskiego 02"},
...
P03:{
  ...
  "Michałów - Pętla":[
      ...
      {n:"Matejki 02"},
      {n:"Wyszyńskiego 02"},
      {n:"OSP Długa Kościelna 02"},
      {n:"Halinów-Szkoła 02"},
      {n:"Mickiewicza (Halinów) 01"},
      {n:"PKP Halinów"},
      {n:"Jana Pawła II (Halinów) 01"},
      {n:"Stawy 02"},
      {n:"Czereśniowa 02"},
      {n:"Dzikiej Róży 02"},
      {n:"Tatrzańska 02"},
...
P04:{
    ...
    "Wólka Piecząca":[
        ...
        {n:"Urząd Miasta 03"},
        {n:"11 Listopada 02"},
        {n:"Urząd Gminy Mińsk Mazowiecki 03"},
        {n:"Chełmońskiego 05"},
        {n:"Jasna 02"},
        {n:"Karolina 04"},
        {n:"Małaszczyckiej 04"},
        ...
        {n:"Dłużka 02"},
        {n:"Dłużka II 02"},
        {n:"Borek Czarniński II 02"},
        {n:"Borek Czarniński I 02"},
        {n:"Szymankowszczyzna 02"},
        {n:"Szymankowszczyzna II 02"},
        {n:"Wólka Czarnińska III 02"},
        {n:"Wólka Czarnińska II 02"},
        {n:"Wólka Czarnińska 02"},
        {n:"Legacz 02"},
        {n:"Rynek (Stanisławów) 01"},
        {n:"Prądzewo III 02*"},
        {n:"Prądzewo II 02*"},
        ...
        {n:"Rządza II 02*"},
        {n:"Rządza I 02*"},
        {n:"Wólka Piecząca III 02*"},
        {n:"Wólka Piecząca II 02*"},
        {n:"Wólka Piecząca 02*"},
        {n:"Kolonie Stanisławów 02*"},
        {n:"Wólka Piecząca 01*"}
        ],
    ...
    "Mińsk Mazowiecki /Dw. PKP/":[
        ...
        {n:"Prądzewo III 01*"},
        {n:"Wólka Piecząca 02*"},
        {n:"Kolonie Stanisławów 01*"},
        {n:"Rynek (Stanisławów) 01"},
        {n:"Legacz 01"},
        {n:"Wólka Czarnińska 01"},
        {n:"Wólka Czarnińska II 01"},
        {n:"Wólka Czarnińska III 01"},
        {n:"Szymankowszczyzna II 01"},
        {n:"Szymankowszczyzna 01"},
        {n:"Borek Czarniński I 01"},
        {n:"Borek Czarniński II 01"},
        {n:"Dłużka II 01"},
        {n:"Dłużka 01"},
        {n:"Prosta 01"},
        {n:"Małaszczyckiej 01"},
        ...
        {n:"Jasna 01"},
        {n:"Chełmońskiego 02"},
        {n:"Urząd Gminy Mińsk Mazowiecki 04"},
        {n:"11 Listopada 01"},
        {n:"Kościuszki 02"},
        {n:"Kazikowskiego 02"},
        {n:"Mińsk Mazowiecki /Dw. PKP/ 08
